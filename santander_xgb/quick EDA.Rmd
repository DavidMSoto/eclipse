...
> The Santander Group is a Spanish banking group centered on Banco Santander,
> S.A. As its name suggests, the company originated in Santander, Cantabria,
> Spain.  
The group has expanded since 2000 through a number of acquisitions, with
> operations across Europe, Latin America, North America and Asia. Many
> subsidiaries, such as Abbey National, have been rebranded under the Santander
> name.  
The company is a component of the Euro Stoxx 50 stock market index. In May 2016,
> Santander was ranked as 37th in the Forbes Global 2000 list of the world's
> largest companies.
https://www.kaggle.com/donyoe/santander-product-recommendation/santander-quick-first-view
...
train <- fread("../input/train_ver2.csv",select = selectrow)
...
It looks that we have the same number of elements the first six months, then a
big gap and later the number of products increases constantly.
...
```
 ...
 There is a significant rise in July that remains until Autumn, this might be
because July is the first month in Spain with vacations, and also we can see
that between September and October has the most number of first holders, that is
because in Spain, the academic calendar starts in September-October and is
considerate like a "new year", very prone to doing new things, like, for
example, to open a new bank account.
...
* p-value<0.05, we can accept that the particular group have more household
  income than the college graduated
...
Hmm, there are some people with age <18 and with more than 118, we might remove
that, lets see how many people are there:

We have `r train[age<18,.N] ` people with <18 years and `r train[age>=118,.N] `
with more than  118 years


Lets do the summary without them: ```{r, echo=FALSE}
