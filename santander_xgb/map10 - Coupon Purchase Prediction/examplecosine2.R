...
#https://www.kaggle.com/c/coupon-purchase-prediction/leaderboard
...
train$DISPPERIOD[train$DISPPERIOD>8] <- 8.0;
...
require(Matrix)
weightm <- c(1.96, 1.25, 1.25, 1.0, 4.50, 0.625, 0.40) # males weights
weightf <- c(1.75, 0.75, 1.50, 1.0, 4.50, 0.625, 0.25) # female weights
...
write.csv(submission, file="150924submit_8.csv", row.names=FALSE)
